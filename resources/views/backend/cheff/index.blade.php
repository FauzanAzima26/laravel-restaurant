...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a href="{{route('chef.create')}}" class="btn btn-outline-gray-600 d-inline-flex align-items-center">
            ...
            <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('chef.show', $item->uuid)}}" class="btn btn-sm btn-primary" title="View"><i class="bi bi-eye"></i></a>
                            <a href="{{route('chef.edit', $item->uuid)}}" class="btn btn-sm btn-warning" title="Edit"><i class="bi bi-pencil-square"></i></a>
                            <button class="btn btn-sm btn-danger" title="Delete" onclick="deleteChef(this)" data-uuid="{{$item->uuid}}"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
                    @empty
                    <tr>
