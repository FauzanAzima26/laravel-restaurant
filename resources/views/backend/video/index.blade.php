                ...
                <tbody>
                    ...
                    @forelse ($videos as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="{{route('video.show', $item->uuid)}}" class="btn btn-sm btn-primary"
                                                    title="View"><i class="bi bi-eye"></i></a>
                                                <a href="{{route('video.edit', $item->uuid)}}" class="btn btn-sm btn-warning"
                                                    title="Edit"><i class="bi bi-pencil-square"></i></a>
                                                <button class="btn btn-sm btn-danger" title="Delete" onclick="deleteVideo(this)"
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center">No video found</td>
                        </tr>
                    @endforelse
                    <!-- End of Item -->
                </tbody>
