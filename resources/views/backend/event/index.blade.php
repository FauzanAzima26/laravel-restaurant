...
<div class="py-4">
    ...
    <div class="d-flex justify-content-between w-100 flex-wrap">
        ...
        <div>
            <a href="{{route('event.create')}}" class="btn btn-outline-gray-600 d-inline-flex align-items-center">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-centered table-nowrap mb-0 rounded">
                <thead class="thead-light">
                    <tr>
                        <th class="border-0 rounded-start text-center" width="5%">No</th>
                        <th class="border-0 text-center" width="25%">Name</th>
                        <th class="border-0 text-center">Price</th>
                        <th class="border-0 text-center" width="20%">Image</th>
                        <th class="border-0 text-center" width="10%">Status</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="{{route('event.show', $item->uuid)}}" class="btn btn-sm btn-primary" title="View"><i class="bi bi-eye"></i></a>
                            <a href="{{route('event.edit', $item->uuid)}}" class="btn btn-sm btn-warning" title="Edit"><i class="bi bi-pencil-square"></i></a>
                            <button class="btn btn-sm btn-danger" title="Delete" onclick="deleteEvent(this)" data-uuid="{{$item->uuid}}"><i class="bi bi-trash"></i></button>
                        </td>
                    </tr>
